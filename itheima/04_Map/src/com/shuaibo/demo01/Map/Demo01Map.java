package com.shuaibo.demo01.Map;
...
public class Demo01Map {
    ...
    private static void show02() {
        ...
        //int v2 = map.remove("林志应"); //自动拆箱  NullPointerException空指针异常
        Integer v2 = map.remove("林志应");
    ...
    private static void show01() {
        ...
        System.out.println("v2 :" + v2);   // v2 :范冰冰1  因为返回被替换的元素
