package com.kangshuibo.demo03.ReverseStream;
...
/*
    ...
    OutputStreamWriter是字符流通向字节流的桥梁：可使用指定的 charset 将要写入流中的字符编码成字节(编码：把能看懂的变成看不懂的)
    ...
    使用步骤：
        ...
        3。使用OutputStreamWriter对象中的方法flush，把内存缓冲区中的字节刷新到文件中（使用字节流 写字节的过程）
        4。释放资源
