package com.shuaibo.Demo07.Prop;
...
public class Demo01Properties {
    ...
    /*
        ...
        使用步骤：
            ...
            3。使用Peoperties集合中的方法store，把集合中的临时数据，持久化写入到硬盘中存储
            4。释放资源
    ...
    */
    ...
    /*
        使用properties集合存储数据，遍历取出propertis集合中的数据
        properties集合是一个双列集合，key和value默认都是字符串
    ...
    private static void show01() {
        ...
        prop.setProperty("迪丽热巴","165");
        prop.setProperty("古力娜扎","160");
        //prop.put(1,true);   //也可以，但任意类型都可以添加了，不建议使用，要使用特有方法
